/*
  ...
  -- ВРЕМЕННАЯ СЛОЖНОСТЬ --
  Сложность = O(n * m) + O(s * min(s, m)).
  1. Создание префиксного дерева O(n * m)
  2. Проход по строке O(s * min(s, m)) в худшем случае

  -- ПРОСТРАНСТВЕННАЯ СЛОЖНОСТЬ --
  Сложность = O(m) + O(s).
  1. Доп. память для хранения префиксного дерева O(m) = O(m * k), где k - мощность алфавита (26)
